...
# 假设有novamind.models.deepseek
from novamind.models.deepseek import DeepSeekModel, DeepSeekConfig

async def main():
    load_dotenv()
    api_key = os.getenv("DEEPSEEK_API_KEY")
    model = DeepSeekModel(DeepSeekConfig(model_name="deepseek-chat", api_key=api_key))
    agent = Agent(name="deepseek_chat", model=model, description="DeepSeek对话助手")
